...
export const GET = withMonitoring("transactions/[id]", GETHandler);
export const PUT = withMonitoring("transactions/[id]", PUTHandler);
export const DELETE = withMonitoring("transactions/[id]", DELETEHandler);
